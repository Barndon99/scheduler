...
storiesOf("Confirm", module)
  ...
  .add("Confirm", () => <Confirm message="Delete the appointment?" onConfirm={action("onConfirm")} onCancel={action("onConfirm")} />)
...
storiesOf("Error", module)
  ...
  .add("Error", () => <Error message="Sorry an error has occured" onClose={action("Close")} />)